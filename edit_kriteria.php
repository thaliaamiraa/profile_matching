				...
				<div class="col-sm-6 offset-sm-3">
					<div class="form-group">
						...
						<select name="id_aspek" id="id_aspek" class="form-control" required="true">
							...
							<option value="2" <?php if ($id_aspek == "2"){ echo "selected"; } ?>>Sikap Kerja</option>
							<option value="3" <?php if ($id_aspek == "3"){ echo "selected"; } ?>>Perilaku</option>
						</select>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<select name="target" id="target" class="form-control" required="true">
							<option value="1" <?php if ($target == "1"){ echo "selected"; } ?>>1 Kurang</option>
							<option value="2" <?php if ($target == "2"){ echo "selected"; } ?>>2 Cukup</option>
							<option value="3" <?php if ($target == "3"){ echo "selected"; } ?>>3 Baik</option>
							<option value="4" <?php if ($target == "4"){ echo "selected"; } ?>>4 Sangat Baik</option>
							<option value="5" <?php if ($target == "5"){ echo "selected"; } ?>>5 Amat Sangat Baik</option>
